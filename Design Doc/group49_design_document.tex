...
OpenAL & An open-source audio library API that is based off of OpenGL so that audio can be implemented with a 3D render in a familiar fashion as OpenGL. \\ \hline
