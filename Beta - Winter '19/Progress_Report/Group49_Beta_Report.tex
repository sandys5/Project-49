...
\begin{figure}[!htb]
    \includegraphics[width=0.6\textwidth]{View1.eps}
    \centering
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.6\textwidth]{View2.eps}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.6\textwidth]{View3.eps}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.6\textwidth]{View5.eps}  \caption{Landing Site}
\end{figure}

\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.6\textwidth]{View7.eps}
    \caption{View of Earth from Moon}
\end{figure}

\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.6\textwidth]{View0.eps}  \caption{Lunar lander Descending}
\end{figure}
