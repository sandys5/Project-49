...
\section{Intro to Project}
Who requested it? - OMSI/Jim Todd
Why was it requested? - 50th anniversary/get excited about space.
What is its importance? - See above
Who was/were your client(s)? - Jim Todd, Mike Bailey
Who are the members of your team? - You better know at this point...
What were their roles? - Shannon did audio, Dean did keyframing, Jonathan did flight path, we all worked on objects, textures, lighting, etc.
What was the role of the client(s)? (I.e., did they supervise only, or did they participate in doing development) - Met 2 times, helped design and offered feedback, not very involved. 
...
\section{OpenGL --- ``The Industry's Foundation for High Performance Graphics''}
...
\section{Unity –-- ``The World's Leading Real-Time Engine''}
...
\section{DirectX –-- ``Are you excited? You will be''}
