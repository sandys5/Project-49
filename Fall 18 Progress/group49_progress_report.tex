...
\hline
    ...
    \hline
     All of the resources we need are readily available to us. & The design document, some of the things we do not have access too, such as the SDK for the planetarium, we will need to gain access to that at a later date. &Mike Bailey will be trying to contact the company that built the planetarium for OMSI, as we expect it is an inhouse SDK.\\ 
     \hline
     Our client from OMSI isn't the best at communicating, but Mike provided all of the info for us!&We need to do a lot of boiler plate code to set up our project.&We are all going to be working on it throughout the winter break progressively.\\
     \hline
     The project has been moving consistently forward without any hiccups or problems.&We need to have extensive knowledeg of shaders to possibly make the scene even better, more than what we know now.&Dean Akin will be taking a shaders course with Mike Bailey to fill us in with the tips and tricks about shaders.\\
     \hline
